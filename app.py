...
st.write('<div style="font-size: 36px; font-weight: bold; color: #FFD700; text-shadow: 2px 2px 4px #000000; margin-top: 20px;">Style Your Look, Find Your Perfect Hairstyle!</div>', unsafe_allow_html=True)
